...
SharedData.MaxAmmo    = {
    AMMO_PISTOL = 200,
    AMMO_PISTOL_EXPRESS = 200,
    AMMO_PISTOL_EXPRESS_EXPLOSIVE = 200,
    AMMO_PISTOL_HIGH_VELOCITY = 200,
    AMMO_PISTOL_SPLIT_POINT = 200,
    AMMO_REPEATER = 200,
    AMMO_REPEATER_EXPRESS = 200,
    AMMO_REPEATER_EXPRESS_EXPLOSIVE = 200,
    AMMO_REPEATER_HIGH_VELOCITY = 200,
    AMMO_REPEATER_SPLIT_POINT = 200,
    AMMO_REVOLVER = 200,
    AMMO_REVOLVER_EXPRESS = 200,
    AMMO_REVOLVER_EXPRESS_EXPLOSIVE = 200,
    AMMO_REVOLVER_HIGH_VELOCITY = 200,
    AMMO_REVOLVER_SPLIT_POINT = 200,
    AMMO_RIFLE = 200,
    AMMO_RIFLE_ELEPHANT = 200,
    AMMO_RIFLE_EXPRESS = 200,
    AMMO_RIFLE_EXPRESS_EXPLOSIVE = 200,
    AMMO_RIFLE_HIGH_VELOCITY = 200,
    AMMO_RIFLE_SPLIT_POINT = 200,
    AMMO_22 = 200,
    AMMO_22_TRANQUILIZER = 200,
    AMMO_SHOTGUN = 200,
    AMMO_SHOTGUN_BUCKSHOT_INCENDIARY = 200,
    AMMO_SHOTGUN_SLUG_EXPLOSIVE = 200,
    AMMO_SHOTGUN_SLUG = 200,
    AMMO_ARROW = 20,
